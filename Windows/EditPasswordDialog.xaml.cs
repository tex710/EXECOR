...
namespace HackHelper
{
    ...
    {
        public PasswordEntry EditedPassword { get; private set; }
        private PasswordEntry originalPassword;
        private bool isPasswordVisible = false;
        private string selectedIconBase64 = null;

        public EditPasswordDialog(PasswordEntry password)
        {
            InitializeComponent();
        ...
        {
            ServiceTextBox.Text = originalPassword.ServiceName;
            UsernameTextBox.Text = originalPassword.Username;
            EmailTextBox.Text = originalPassword.Email;
            PasswordBox.Password = originalPassword.Password;
            PasswordTextBox.Text = originalPassword.Password;

            // Load existing icon
            selectedIconBase64 = originalPassword.IconBase64;
            ...
            // Update strength indicator with loaded password
            UpdatePasswordStrength(originalPassword.Password);
        }
        ...
        private void Save_Click(object sender, RoutedEventArgs e)
        {
            ...
            EditedPassword = new PasswordEntry
            {
                Id = originalPassword.Id,
                ServiceName = ServiceTextBox.Text,
                Username = UsernameTextBox.Text,
                Email = EmailTextBox.Text,
                Password = GetCurrentPassword(),
                Notes = originalPassword.Notes,
